# -*- coding: utf-8 -*-
"""
Created on Tue Mar  1 16:30:14 2022
...
Citibank
Compute portfolio_variance by using the @ matrix operator to multiply the transpose of weights, 
the covariance matrix, and untransposed weights together. 
This is used to find and display the portfolio_volatility.
'''
...
#Using this histogram for comparison, which distribution(s) in plt.figure(1) fit losses best?
